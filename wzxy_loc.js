...
function doSign({id, logId}) {
    ...
    $task.fetch(doSignRequest).then(response => {
...
function getSignMessageByPage(page) {
    return new Promise((resolve, reject) => {
        ...
        $task.fetch(getSignMessageRequest).then(response => {
            const responseBody = JSON.parse(response.body);
...
/*
未开始：
{"code":0,"data":{"areas":[{"distance":1200,"latitude":"30.2090300000","longitude":"115.0258700000","name":"校本部"}],"date":"11-23 08:29","devices":[],"end":"11-29 23:00","id":"250900667593197568","phone":"17683733332","qrcodeId":"0","start":"11-29 21:00","state":0,"studentId":"217018292841027584","studentName":"熊维建","time":"8732分钟","title":"校区签到","type":3,"userName":"姜礼朋","uuids":[]}}
未签到：

已签到：
{"code":0,"data":{"areas":[{"distance":1200,"latitude":"30.2090300000","longitude":"115.0258700000","name":"校本部"}],"date":"11-21 09:33","devices":[],"end":"11-22 23:00","id":"250192060723236864","phone":"17683733332","qrcodeId":"0","start":"11-22 21:00","state":2,"studentId":"217018292841027584","studentName":"熊维建","time":"---","title":"校区签到","type":1,"userName":"姜礼朋","uuids":[]}}
* */